...
| [`principios-audit`](./principios-audit/) | Varredura de princípios contra o `AGENTS.md`: SSOT, DRY, SRP, hexagonal, TDD, código morto, YAGNI/KISS. Comandos: `/principios-audit`, `/hexagonal-audit` |
